...
import useGetWave from '../hooks/useGetWave';
...
const LongitudOnda = () => {
    ...
    const [resultWave, setResultWave] = useState({});
    ...
    const {medium, frecuency} = longitud;

    const result = useGetWave(medium, frecuency);

    const handleSubmit = (e) => {
        e.preventDefault();
        setResultWave(result);
    }
                        ...
                        <div className="col">
                            <form onSubmit={handleSubmit} >
                                <div className="form-group">
                                    <label htmlFor="medium" className="tit"> <b>Medio</b> </label>
                                    <select className="form-control" name="medium" id="selec" onChange={handleChange}>
                                ...
                                <br/>
                                <div className="form-group">
                                    <label htmlFor="frecuency" className="tit"> <b>Frecuencia</b> </label>
                            ...
                            <div className="card" id="tarjeta">
                                <ul className="list-group list-group-flush">
                                    <li className="list-group-item" id="res">
                                        <h2 className="subtit"> <b>λ= v &#47; F</b> </h2>
                                    </li>
                                    <li className="list-group-item">
                                        <br/>
                                        <h4> <b>Res:</b> </h4>
                                        <br/>
                                        <h4 className="centro">{resultWave.longitudonda}</h4>
                                        <br/>
                                    </li>
                                </ul>
                            </div>

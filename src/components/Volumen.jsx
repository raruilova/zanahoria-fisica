                            ...
                            <div class="col">
                                <form action="">
                                    <div className="form-group">
                                        ...
                                        <input type="text" className="form-control form-control-md" name="preasure1" id="seltexto" required=""/>
                                    </div>
                                    <br/>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-md" name="temperature1" id="seltexto" required=""/>
                                    </div>
                                    <br/>
                                    <div class="form-group">
                                        <label for="uname1" class="tit">
                                        ...
                                        <input type="text" class="form-control form-control-md" name="preasure2" id="seltexto" required=""/>
                                    </div>
                                    <br/>
                                    <div class="form-group">
                                        <label for="uname1" class="tit">
                                        ...
                                        <input type="text" class="form-control form-control-md" name="temperature2" id="seltexto" required=""/>
                                    </div>
                                    <br/>
                                    <div class="form-group">
